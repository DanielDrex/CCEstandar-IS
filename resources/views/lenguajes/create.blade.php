...
<head>
	<meta charset="utf-8">
	<title>Registrar lenguaje</title>
...
<body>
	<div class="jumbotron-jumbotron-fluid">
		<div class="container">
			...
			<p class="lead">Registrar lenguaje </p>
		</div>
		...
		<div>
			{!! Form::open(['url'=>'/lenguajes']) !!}

			<div class="opciones">
				<div class="input-group mb-3">
					<span class="input-group-text" id="basic-addon1">Nombre</span>
					<input type="text" class="form-control" placeholder="Nombre de lenguaje" aria-label="Username" aria-describedby="basic-addon1" name="nombre" id="validationCustom01" required>
				</div>
			</div>
			...
			<div class="opciones">
				<div class="input-group mb-3">
					...
					<input type="text" class="form-control" placeholder="ejemplo: py, java...." aria-label="Username" aria-describedby="basic-addon1" name="extension" id="validationCustom01" required>
				</div>
			</div>
