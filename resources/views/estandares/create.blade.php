		...
		<div>
			...
			<div class="opciones">
				<div class="input-group mb-3">
					...
					<input type="text" class="form-control" placeholder="Nombre del estandar" aria-label="Username" aria-describedby="basic-addon1" name="nombre" id="validationCustom01" required>
				</div>
			</div>
