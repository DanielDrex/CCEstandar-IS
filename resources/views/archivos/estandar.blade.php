...
<body>
	<div class="jumbotron-jumbotron-fluid">
		<div class="container">
			...
			<p class="lead">Selecciona un estandar para evaluar en el lenguaje: </p>
			<p class="lead">{!! $lenguaje->nombre !!} </p>
		...
		<div class="listado">
			<table>
				...
				<tr>
					...
					<td class="opc">
						<a class="btn btn-primary" href="{!! asset('evaluar/'.$estandar->id.'/'.$archivo->id) !!}" role="button">Seleccionar estandar y evaluar</a>
					</td>
				</tr>
				@endforeach
			</table>
