...
<body>
	<div class="jumbotron-jumbotron-fluid">
		<div class="container">
			...
			<p class="lead">Edicion de apartados </p>
		</div>
		...
		<div>
			...
			<div class="opciones">
				<div class="input-group mb-3">
					...
					<input type="text" class="form-control" placeholder="Nombre del estandar" aria-label="Username" aria-describedby="basic-addon1" name="nombre" id="validationCustom01" required value="{!! $apartado->nombre!!}">
				</div>
			</div>
		</div>
		<div class="opcnuevas">
